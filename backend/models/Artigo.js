...
const artigoSchema = new mongoose.Schema({
  ...
  // RFID
  rfidEnabled: { type: Boolean, default: false, index: true },
  rfidScanStatus: {
    type: String,
  ...
  rfidTagsCount: { type: Number, default: 0, min: 0 },
  rfidScanStartedAt: { type: Date, default: null },
  rfidScanFinishedAt: { type: Date, default: null },
  ...
  dataInicioProducao: { type: Date, required: false },
  dataFimProducao: { type: Date, required: false }
}, { timestamps: true });
